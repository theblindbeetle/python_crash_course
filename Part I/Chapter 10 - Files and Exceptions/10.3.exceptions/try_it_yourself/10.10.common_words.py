...
• Write a program that
    • reads the files you found at Project Gutenberg
...
with open(filename, encoding='utf-8') as f:
    ...
    message_1 = f"count of 'the': {contents.lower().count('the')}"
    print(message_1)
    message_2 = f"count of 'the ' (with space): "
    message_2 +=  str(contents.lower().count('the '))
    print(message_2)